...
class ChuanglanSmsApi {
	...
	private $apiAccount; // 创蓝API账号
	
	private $apiPassword; // 创蓝API密码
	 ...
	 * @param string $reportStatus 	是否需要状态报告
	 */
	public function sendSMS($mobile, $msg, $reportStatus = 'true') {
	 ...
	 */
	public function sendTemplateSMS($mobild, $msg, $params) {
		//创蓝接口参数
		$postArr = array (
			'account'  =>  $this->apiAccount,
			'password' => $this->apiPassword,
